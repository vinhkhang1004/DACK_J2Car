      ...
      <main className="auth-container">
        ...
        <div className="auth-hero">
          ...
          <p className="muted" style={{ fontSize: "1.1rem", maxWidth: "480px", marginBottom: "2rem" }}>
            Mạng lưới kết nối kỹ sư và đam mê. Truy cập danh mục hơn 200.000 phụ tùng ô tô được gia công chính xác.
          </p>
        ...
        <div className="auth-card-section">
          <form className="glass-card" onSubmit={onSubmit}>
            <h2 style={{ fontSize: "1.75rem", marginBottom: "0.5rem" }}>Chào mừng trở lại</h2>
            <p className="muted" style={{ marginBottom: "2rem" }}>
              Nhập thông tin truy cập để vào bảng điều khiển.
            </p>
            ...
            <div className="input-group">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <Link to="#" style={{ fontSize: "0.75rem", color: "#00deff", fontWeight: 600 }}>
                  Quên mật khẩu?
                </Link>
              </div>
              <div className="input-wrapper">
                ...
                <input
                  ...
                  required
                />
                <span className="icon" style={{ left: "auto", right: "1rem", cursor: "pointer" }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "2rem" }}>
              ...
              <label htmlFor="remember" className="muted" style={{ fontSize: "0.85rem", cursor: "pointer" }}>
                Duy trì đăng nhập
              </label>
            </div>

            <button type="submit" className="btn btn-primary" disabled={pending} style={{ width: "100%", height: "52px" }}>
              {pending ? "Đang xác thực..." : "Đăng nhập bảo mật"}
            </button>
            ...
            <p className="muted" style={{ textAlign: "center", fontSize: "0.85rem", marginTop: "2rem" }}>
              Chưa có tài khoản?{" "}
              <Link to="/dang-ky" style={{ color: "var(--accent)", fontWeight: 700 }}>
                Tạo tài khoản
              </Link>
            </p>
          </form>
